...
IF  ~Global("7C#GalileoMelicampComment","GLOBAL",2)~ BEGIN 7c#melicamp.joke.1
  SAY @51 /* Hey <CHARNAME>, I hear Feldepost fetches a fair price for fresh poultry... Only joking. */
    IF ~~ DO ~Global("7C#GalileoMelicampComment","GLOBAL",3)~ EXIT
END

IF ~Global("7C#GalileoDeadHalflingComment","GLOBAL",1)~ BEGIN 7c#galileo.sees.dead.halflings
  SAY @52 /* Well that's only slightly disturbing. */
